...
const RestaurantCard = (props) => {
  ...
  return (
    <>
        <div key={resData?.info.id} className="w-[325px]  shadow-[0_2.8rem_2.8rem_rgba(0,0,0,0.075)] rounded-2xl mb-8 transition duration-300 ease-in-out hover:scale-y-105">
          <img
            src={CDN_URL + cloudinaryImageId}
            alt="resturant image"
            className="h-[200px] w-full rounded-2xl object-cover"
            />
            {/* <p>{resData?.info?.aggregatedDiscountInfoV3?.header}</p> */}
          <div className="p-4">
